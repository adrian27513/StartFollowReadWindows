...
if __name__ == "__main__":
    xml_directory = '../data/Train-A/page'
    img_directory = '../data/Train-A'

    output_directory = 'data/train_a'
    training_output_json = 'data/train_a_training_set.json'
    validation_output_json = 'data/train_a_validation_set.json'
